...
const About = (props) => {
		...
		return (
				<div className='About'>
						<Navbar logo='LOGO' links={<Link to='/' style={{textDecoration: 'none', color: 'white'}}>Home</Link>}/>
						<div className='head'>
								<Title title="About"/>
						</div>
						<div className='profilContainer'>
								...
								<a href='#contact' style={{textDecoration: 'none'}}><h2 className='contactButton'>Contact</h2></a>
								<ContactForm/>
				</div>
		)
}
